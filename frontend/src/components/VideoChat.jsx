		...
		<>
			<div className="bg-gradient-to-br from-slate-200 to-slate-300 rounded-2xl overflow-hidden mb-6 border border-slate-300 w-full ">
				<div className="w-full h-fit aspect-[16/9] relative">
					...
					{stream &&
						(session?.isReported ? (
							<button onClick={() => setIsReportModalOpen(true)} className="absolute bottom-[5%] right-[3%] px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors">
								See Report
							</button>
						) : (
